...
**This is a performance-optimized fork** of the original [termcolor](https://github.com/BurntSushi/termcolor) library by Andrew Gallant. This fork focuses on zero-allocation, high-performance terminal coloring for use in async, real-time applications.

### Original Project Credits

Original work by [Andrew Gallant](https://github.com/BurntSushi) and contributors.  
Original repository: https://github.com/BurntSushi/termcolor

**License preserved from original**: Dual-licensed under MIT or the [UNLICENSE](https://unlicense.org/).
